...
(function() {
  ...
  Game.Level = (function(_super) {
    ...
    Level.prototype._load = function(levelName) {
      this.levelName = levelName != null ? levelName : this.levelName;
      console.log("Loading level " + this.levelName);
    ...
    Level.prototype.finish = function(nextLevel) {
      this.clear();
      Game.EventManager.trigger('level.finish', this, [nextLevel]);
      return this.game.finishLevel(nextLevel);
    };
